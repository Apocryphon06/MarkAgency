      ...
      <div className="lg:px-20 px-5">
        ...
        <div className="lg:mt-20 mt-10">
          ...
          <div className="lg:mt-20 mt-10">
            <div className="flex lg:flex-row flex-col justify-center items-center lg:gap-10 gap-5">
              <div className="flex flex-col justify-center items-center bg-[#E9E9EC] w-[300px] p-10 text-center h-[350px]">
                <img src={marketAssess} alt="" />
                <p className="text-xl font-medium">Market Assessment</p>
              ...
              <div className="flex flex-col justify-center items-center bg-[#1E2B57] w-[300px] p-10 text-center h-[350px] text-white relative lg:top-[-50px]">
                <img src={virtual} alt="" />
                <p className="text-xl font-medium">Virtual initiative</p>
              ...
              <div className="flex flex-col justify-center items-center bg-[#E9E9EC] w-[300px] p-10 text-center h-[350px]">
                <img src={advt} alt="" />
                <p className="text-xl font-medium">Online advertising</p>
                <p className="text-base text-[#808080]">
                  Lorem ipsum dolor sit a consectetur.Maurisimpe pharetra proin
                  felis.
                </p>
        ...
        <div className="lg:mt-40 mt-10 flex flex-col justify-center items-center">
          <div className="text-center">
            ...
            <p className="lg:text-5xl text-2xl font-medium">Our Latest Media</p>
          </div>
